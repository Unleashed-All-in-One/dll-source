...
#			define HK_FORCE_INLINE __forceinline
    ...
    public:
        ...
        const hk2010_2_0::hkpShape* m_shape;
        ...
        hkEnum<int, hkInt8> m_collisionResponse;
        ...
        /// This defaults to 0,0,0.
        Hedgehog::Math::CVector m_linearVelocity;

        /// The initial angular velocity of the body.
        /// This defaults to 0,0,0.
        Hedgehog::Math::CVector m_angularVelocity;
        ...
        Hedgehog::Math::CMatrix m_inertiaTensor;

        /// The center of mass in the local space of the rigid body.
        /// This defaults to 0,0,0.
        Hedgehog::Math::CVector m_centerOfMass;
        ...
        float m_rollingFrictionMultiplier; //+default(0.0f)
        ...
        hkEnum<int, hkInt8> m_qualityType;
