...
namespace SUC::System
{
	...
	public:
		 ...
		 */
		static CVector Up(const CQuaternion& a);
		static CVector Down(const CQuaternion& a);
		static CVector Left(const CQuaternion& a);
		static CVector Right(const CQuaternion& a);
		static CVector Forward(const CQuaternion& a);
		static CVector Back(const CQuaternion& a);
		...
		static CMatrix44 ToRotationMatrix(const CQuaternion& a);
