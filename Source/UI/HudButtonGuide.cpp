...
namespace SUC::UI
{
	...
	Sonic::EKeyState HudButtonGuide::GetKeyStateFromButtonType(EButtonType in_buttonType)
	{
	...
	void HudButtonGuide::Configure(EButtonType in_ButtonType, EAnimationType in_AnimType)
	{
	...
	void HudButtonGuide::Spawn(Sonic::CGameObject* in_Parent, EButtonType in_ButtonType, EAnimationType in_AnimType)
	{
	...
	void HudButtonGuide::RegisterHooks()
	{
