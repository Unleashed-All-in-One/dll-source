...
namespace BBExt::Animation
{
    ...
    inline CAnimationPose::CAnimationPose(const boost::shared_ptr<Hedgehog::Database::CDatabase>& in_spDatabase,
        const Hedgehog::Base::CSharedString& in_rName) : CAnimationPose(bb_null_ctor{})
    {
